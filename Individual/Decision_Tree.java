...
/**
 * Decision Tree algorithm using Sensorless_drive_diagnosis.csv dataset (sdd)
...
public class Decision_Tree {
	...
	public static void main(String[] args) {
                ...
                String data_path = "input/Sensorless_drive_diagnosis.csv";
                SparkSession spark = SparkSession.builder().appName("Decision_Tree").
				getOrCreate();
                Dataset<Row> sddCSV = spark.read().format("csv").load(data_path);
                sddCSV.show();
      		// convertTOJavaRDD
		...
		Dataset<Row>[] splits = data.randomSplit(new double[] { 0.7, 0.3 },321);
